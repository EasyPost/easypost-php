    ...
    private function _requestRaw($method, $url, $params)
    {
        ...
        if (!$myApiKey) {
            if (!$myApiKey = EasyPost::$apiKey) {
                throw new Error('No API key provided. Set your API key using "EasyPost::setApiKey(<API-KEY>)". See https://geteasypost.com/docs for details, or contact us at contact@geteasypost.com for assistance.');
            }
        }
